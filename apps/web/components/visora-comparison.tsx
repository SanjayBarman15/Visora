...
export function VisoraComparison() {
  return (
    <section className="relative bg-slate-50 dark:bg-[#07090e] py-24 border-b border-border overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-3xl mx-auto text-center mb-16">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-yellow-500/20 bg-yellow-500/10 text-yellow-600 dark:text-yellow-400 text-xs font-mono mb-4">
          ...
          <p className="text-slate-650 dark:text-slate-400 leading-relaxed font-sans">
        ...
        <div className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8">
          {/* Mova Side */}
          <div className="relative rounded-2xl border border-emerald-500/25 bg-white dark:bg-slate-950/40 p-8 shadow-xl backdrop-blur-sm">
            <div className="absolute top-0 right-8 -translate-y-1/2 bg-emerald-500/10 text-emerald-600 dark:text-emerald-400 border border-emerald-500/30 text-[10px] font-mono px-3 py-1 rounded-full uppercase tracking-wider">
              Visora (Code-Driven)
            </div>
            
            <div className="flex items-center gap-3 mb-6">
              <div className="p-2 rounded-lg border border-emerald-500/20 bg-emerald-500/10 text-emerald-650 dark:text-emerald-400">
                <Code2 className="w-5 h-5" />
              </div>
              <h3 className="text-lg font-bold text-slate-900 dark:text-white">Mathematical Engine</h3>
            </div>
          ...
          {/* Generic AI Side */}
          <div className="relative rounded-2xl border border-slate-200 dark:border-slate-900 bg-slate-100/50 dark:bg-slate-950/20 p-8 opacity-65 hover:opacity-90 transition-opacity backdrop-blur-sm">
            <div className="absolute top-0 right-8 -translate-y-1/2 bg-slate-200 dark:bg-slate-800 text-slate-600 dark:text-slate-400 border border-slate-300 dark:border-slate-700 text-[10px] font-mono px-3 py-1 rounded-full uppercase tracking-wider">
              Generic AI (Pixel-Diffusion)
            </div>

            <div className="flex items-center gap-3 mb-6">
              <div className="p-2 rounded-lg border border-slate-200 dark:border-slate-800 bg-slate-100 dark:bg-slate-900/40 text-slate-500 dark:text-slate-400">
                <AlertTriangle className="w-5 h-5" />
              </div>
              <h3 className="text-lg font-bold text-slate-900 dark:text-white">Diffusion Video</h3>
            </div>
