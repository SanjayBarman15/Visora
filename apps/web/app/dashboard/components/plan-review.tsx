...
export function PlanReview() {
  ...
  return (
    <div className="flex-1 flex flex-col md:flex-row overflow-hidden">
      ...
      <div className="w-full md:w-[400px] border-r border-slate-200 dark:border-slate-900 bg-white dark:bg-[#07090e]/40 flex flex-col shrink-0">
      ...
      <div className="flex-1 flex flex-col bg-slate-50/50 dark:bg-[#05070a]/50 p-6 overflow-y-auto">
        <div className="max-w-3xl mx-auto w-full space-y-6">
          <div className="flex justify-between items-center">
            ...
            <Button
              ...
              className="bg-emerald-500 hover:bg-emerald-600 text-slate-950 font-bold px-5 py-2.5 rounded-lg shadow-[0_0_15px_rgba(16,185,129,0.15)] text-xs flex items-center gap-1.5 cursor-pointer"
            >
          ...
          <div className="space-y-4">
            {activeProject.scenes?.map((scene, idx) => (
              <div
                key={scene.id}
                className="bg-white dark:bg-card border border-border rounded-xl p-4.5 shadow-md flex gap-4 items-start hover:border-slate-350 dark:hover:border-slate-800 transition-colors"
              >
                <div className="flex flex-col gap-1 items-center justify-center pt-1">
                  <span className="text-[10px] font-mono text-slate-450 bg-slate-100 dark:bg-slate-900 w-6 h-6 flex items-center justify-center rounded-full border border-border">
                    {idx + 1}
                  </span>
                  <div className="flex flex-col gap-0.5 mt-2">
                    <Button
                      ...
                      className="w-5 h-5 text-slate-500 hover:text-white disabled:opacity-30 cursor-pointer"
                    >
                ...
                <div className="flex-1 space-y-3">
                  ...
                  <textarea
                    ...
                    rows={2}
                    className="bg-transparent text-slate-650 dark:text-slate-400 text-xs w-full resize-none focus:outline-none focus:border-b border-sky-500/20 leading-relaxed"
                  />
                </div>
